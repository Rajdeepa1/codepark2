...
$sql ="SELECT sid,item_id,item_name,item_desc,min_amt,bid_start,end_bid,photo FROM item  WHERE end_bid>= curdate() and bid_start<=curdate() and item_name LIKE '%".$name."%' and bid is null ORDER BY min_amt asc";
