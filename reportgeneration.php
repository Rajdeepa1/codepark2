...
?>
    ...
    <div class="navigation">
        <h1 style=text-align:center; id="logo">VIEW USER</h1>
        </div>
    <br>
    <hr>
    <hr>
...
$sql ="SELECT item_id,sid,seller_feedback,bid,buyer_feedback from item where bid is not null ";
$result = mysqli_query($conn, $sql);
 echo "<table border='1' align ='center'>";
    echo "<tr>";
	echo "<td>ITEM ID</td>";
        echo "<td>SELLER ID</td>";
        echo "<td>SELLER FEEDBACK</td>";
        echo "<td>BUYER ID</td>";
       
		echo "<td>BUYER FEEDBACK</td>";
        echo "</tr>";
		 ...
		 while($rowitem = mysqli_fetch_array($result))
    {
        ...
        echo "<td>" . $rowitem['seller_feedback'] . "</td>";
        echo "<td>" . $rowitem['bid'] . "</td>";
         echo "<td>" . $rowitem['buyer_feedback'] . "</td>";
