...
?>
    ...
    <div class="navigation">
        <h1 style=text-align:center; id="logo">BIDS</h1>
        </div>
    <br>
    <hr>
    <hr>
...
$sql ="SELECT bidderid,biddername,bidamt from bids where itemid='".$iid."'";
...
?>
    ...
    <div class="clearfix">
        <button type="submit" formaction="bidforitem.php" class="signupbtn1">Go Back</button></form>
